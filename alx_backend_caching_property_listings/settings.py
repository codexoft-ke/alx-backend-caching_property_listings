...
SECRET_KEY = "django-insecure-o+6me9nnp(kp11mxn^o0=otl(hg8b-n(f2c_9$o*6r0yh=@dot"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # Use 'redis://redis:6379/1' when running in Docker network
        "OPTIONS": {
